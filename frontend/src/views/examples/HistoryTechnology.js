import {
            ...
            <div className="col">
              <Card className="shadow">
                <CardHeader className="border-0 d-flex justify-content-between align-items-center">
                  <h3 className="mb-0">Technology History</h3>
                ...
                <Table className="align-items-center table-flush text-center" responsive>
                  <thead className="thead-light">
                    <tr>
                      ...
                      <th scope="col">Old Name / Version</th>
                      <th scope="col">New Technology Name</th>
                      <th scope="col">New Technology Version</th>
                  ...
                  <tbody>
                    {filteredHistory.map((item) => (
                      <tr key={item.id}>
                        ...
                        <td>{item.old_technology_name || '-'} / {item.old_technology_version || '-' }</td>
                        <td>{item.technology_name || '-'}</td>
                        <td>{item.technology_version || '-'}</td>
  ...
  export default HistoryTechnology;